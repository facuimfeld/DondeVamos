...
class RowDirection extends StatefulWidget {
  Event event;
  RowDirection({required this.event});

  @override
  State<RowDirection> createState() => _RowDirectionState();
}

class _RowDirectionState extends State<RowDirection> {
  @override
